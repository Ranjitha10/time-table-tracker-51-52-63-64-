                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        if(!isset($time))
                        {
                            ...
                            $query2 = "SELECT sem FROM student WHERE usn = '$user';";
                            $result2 = mysqli_query($con,$query2);
                            $row2 = mysqli_fetch_assoc($result2);
                            $sem = $row2['sem'];

                            //execute query and report failure
                            $query="SELECT * from class WHERE CAST('$time' as time) between start_time and end_time and day='$day' and sem='$sem' ;";
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index_student.php">Home Page</a>
                            </li>
                        </ol>
                    </div>
                </div>
