    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index_teacher.php">Time Table Tracker</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav top-nav">
                    <li class="">
                        <a href="home_redirect.php"><i class="fa fa-fw fa-home"></i>Home</a>
                    </li>
                    ...
                    ?>
                        ...
                        <li>
                            <a href="mail_counsellors.php"><i class="fa fa-fw fa-envelope-o "></i> Send mails to Mentees</a>       
                        </li>
                        <li class="">
